...
plt.title('Hierarchical Clustering Dendrogram on Original Student distance matrix(truncated)')
...
plt.title('Hierarchical Clustering Dendrogram on PP Student distance matrix(truncated)')
plt.xlabel('cluster size')
plt.ylabel('distance')
...
plt.title('Hierarchical Clustering Dendrogram on RR Student distance matrix(truncated)')
plt.xlabel('cluster size')
plt.ylabel('distance')
